...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    help_text = (
        ...
        "1. Откройте корзину Card Kingdom в браузере\n"
        "2. Нажмите кнопку 'Поделиться'\n"
        "3. Выберите 'Сохранить страницу'\n"
        "4. Сохраните как 'Веб-страница, только HTML'\n"
        "5. Отправьте сохраненный файл мне\n\n"
        "💻 На компьютере:\n"
        "1. Откройте корзину Card Kingdom\n"
        "2. Нажмите Ctrl+S (Cmd+S на Mac)\n"
        "3. Выберите 'Веб-страница, только HTML'\n"
        "4. Сохраните файл\n"
        "5. Перешлите файл в Telegram и отправьте мне\n\n"
        "📋 Альтернативный способ:\n"
        "1. Откройте корзину Card Kingdom\n"
        "2. Нажмите Ctrl+U (Cmd+Option+U на Mac) - откроется исходный код\n"
        "3. Скопируйте весь текст (Ctrl+A, Ctrl+C)\n"
        "4. Отправьте мне скопированный текст\n\n"
        "⚙️ Технические детали:\n"
        "• Поддерживаемые форматы: .html, .txt\n"
        "• Максимальный размер: 25 MB\n"
        "• Обработка занимает 5-15 секунд\n"
        "• Выходной формат: .xlsx (Excel)\n\n"
        "❌ Частые ошибки:\n\n"
        "❗️ 'Файл не найден'\n"
        "→ Убедитесь, что файл загрузился полностью\n\n"
        "❗️ 'В корзине не найдено карт'\n"
        "→ Проверьте, что корзина не пустая\n"
        "→ Убедитесь, что сохранили именно страницу корзины\n\n"
        "❗️ 'Ошибка парсинга HTML'\n"
        "→ Сохраните страницу заново\n"
        "→ Попробуйте другой браузер\n"
        "→ Убедитесь, что сохранили 'только HTML'\n\n"
        "❗️ 'Файл слишком большой'\n"
        "→ Попробуйте разделить заказ на части\n\n"
        "💡 Советы:\n"
        "• Сохраняйте 'только HTML' без картинок\n"
        "• Не редактируйте HTML файл вручную\n"
        "• Проверьте корзину перед сохранением\n\n"
        "🆘 Проблемы?\n"
